...
-	Oxytocin: made of 9aas, causes uterine contraction and milk let-down
-	Arginine Vasopressin (AVP/ADH): 9aas, regulates water absorption in kidneys
Anterior Pituitary Hormones (Tropic):
-	Adrenocorticotropic hormone (ACTH): Regulates cortisol secretion from adrenal cortex
-	Thyroid stimulating hormone (TSH): Regulates secretion of iodothyronines in thyroid gland
-	Follicle-stimulating hormone (FSH): Regulates gametogenesis in gonads
-	Luteinizing hormone (LH): Regulates steroidogenesis in gonads
-	Growth hormone: Regulates somatomedins (IGF) secretion from liver; regulated by GHRH+GHIH; tumour in somatotrope -> Excessive GH prod -> excessive growth
Anterior Pituitary Hormones (Non-tropic):
-	Growth hormone (GH): Regulates growth and metabolism in a variety of tissues; peptide
-	Prolactin (PRL): Milk synthesis in mammary gland; Salt/water balance at kidneys and gills in fish
...
-	Olfaction:
o	Agnathans (lampreys): one olfactory organ with a single nostril
o	Elasmobranchs (sharks and rays): the paired olfactory pits or sacs are usually situated on the ventral side of the snout
o	Teleosts (most bony fishes): the paired olfactory organs are usually located on the dorsal side of the head
